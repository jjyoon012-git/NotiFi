...
// Allowed TX MACs for 3TX + 1RX collection.
static const uint8_t CONFIG_CSI_ALLOWED_MACS[][6] = {
    {0x1a, 0x00, 0x00, 0x00, 0x00, 0x00},  // TX1
    {0x1a, 0x00, 0x00, 0x00, 0x00, 0x01},  // TX2
    {0x1a, 0x00, 0x00, 0x00, 0x00, 0x02},  // TX3
};
#define CONFIG_CSI_ALLOWED_MAC_NUM 3

static const char *TAG = "csi_recv";

static void xiao_esp32c6_select_external_antenna(void)
{
    ...
    ESP_LOGI(TAG, "XIAO ESP32-C6 RF switch: GPIO3=LOW, GPIO14=HIGH (external antenna)");
#endif
}
...
void app_main()
{
    ...
    xiao_esp32c6_select_external_antenna();
