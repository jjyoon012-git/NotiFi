...
python scripts/create_session.py --subject mhw --environment E01 --session YYYYMMDD_AM01 --port COM_PORT --camera 0 --firmware-commit FIRMWARE_COMMIT --device-config K0_P0
...
```powershell
python scripts/show_progress.py --subject mhw --environment E01
python scripts/extract_pose13.py --root collection_data/v2/mhw/E01/SESSION_ID --overlay
