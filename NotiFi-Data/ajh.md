...
python scripts/create_session.py --subject ajh --environment E01 --session YYYYMMDD_AM01 --port COM_PORT --camera 0 --firmware-commit FIRMWARE_COMMIT --device-config K0_P0
